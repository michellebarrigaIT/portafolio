...
export const myPortafolio: Portafolio = {
    ...
    user: {
        ...
        isStudent: false,
        description: "Systems Engineer student with hands-on experience in backend, web development, and databases. Passionate about creating efficient and scalable solutions. Seeking oportunities to contribute and grow in a dynamic tech environment.",
